...
## Technical Skills
- C (pointers, memory management, dynamic allocation)
- Python
- Python–C Foreign Function Interface (FFI)
- Performance-oriented programming
- Basic neural computation (from scratch)
...
## Achievements
- Long-term training in Taekwondo
- Independent learner in systems-oriented programming
...
[Technical Portfolio (PDF)](technical-portfolio.pdf)
